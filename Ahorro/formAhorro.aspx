...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:FormView ID="FormViewAhorro" runat="server" AllowPaging="True" DataKeyNames="idAhorro" DataSourceID="SqlDataSourceAhorros">
        <EditItemTemplate>
            <table>
                <tr>
                    <td style="height: 24px">Monto:</td>
                    <td style="height: 24px"><asp:TextBox ID="MontoTextBox" runat="server" Text='<%# Bind("Monto") %>' />   
                    </td>
                    <td style="height: 24px"><asp:RequiredFieldValidator ID="RequiredFieldValidatorMonto" runat="server" ControlToValidate="MontoTextBox" ErrorMessage="Debes ingresar un monto."></asp:RequiredFieldValidator></td>
                </tr>
                <tr>
                    <td>Fecha:</td>
                    <td> 
        ...
        <ItemTemplate>
            <table>
                <tr>
                    <td>Ahorro   #</td>
                    <td> <asp:Label ID="idAhorroLabel" runat="server" Text='<%# Eval("idAhorro") %>' /></td>
                </tr>
                <tr>
                    <td>Monto: </td>
